...
export const SETTINGS_KEY_CATALOG: Record<string, SettingsKeyMeta> = {
  ...
  'sandbox.filesystem.disabled': { since: '2.1.216', descKey: 'sandboxFilesystemDisabled' },
  'sandbox.network.strictAllowlist': { since: '2.1.219', descKey: 'sandboxStrictAllowlist' },
  workflowSizeGuideline: { since: '2.1.219', descKey: 'workflowSizeGuideline' },
  emojiCompletionEnabled: { since: '2.1.217', descKey: 'emojiCompletionEnabled' },
